...
namespace EthereumSamurai.EventProvider.Service.Repositories.ApiClient.Models
{
    ...
    public partial class Erc20TransferHistoryResponse
    {
        ...
        /// class.
        /// </summary>
        public Erc20TransferHistoryResponse(string blockHash = default(string), long? blockNumber = default(long?), long? blockTimestamp = default(long?), string contractAddress = default(string), string fromProperty = default(string), int? logIndex = default(int?), string to = default(string), string transactionHash = default(string), int? transactionIndex = default(int?), string transferAmount = default(string))
        {
            BlockHash = blockHash;
            BlockNumber = blockNumber;
            BlockTimestamp = blockTimestamp;
